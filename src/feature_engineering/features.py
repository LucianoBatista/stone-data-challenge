...
def prop_success_dsp5(data: pd.Series):
...
def prop_success_dsp10(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def prop_success_dsp15(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def prop_success_dsp30(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def prop_success_dsp60(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def prop_success_dsp90(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def prop_success_dspp15(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def prop_success_dspp30(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def prop_success_dspp45(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def total_success_dspp15(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def total_success_dspp30(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def total_success_dspp45(data: pd.Series):
    # your data must have the dsp column
    dsp_list = data.to_list()
...
def get_nao_entregue(data: pd.Series):
    nao_entregue = []
    ...
    for item in data.values:
        if isinstance(item, str):
            ...
            for i in item:
                if i == "NAO ENTREGUE":
                    nao_entregue.append(True)
                else:
                    nao_entregue.append(False)
    return sum(nao_entregue)


def get_lido(data: pd.Series):
    lido = []
